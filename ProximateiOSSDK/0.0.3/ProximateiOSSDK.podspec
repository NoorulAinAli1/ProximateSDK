#
#  Be sure to run `pod spec lint ProximateiOSSDK.podspec' to ensure this is a
...
s.version      = "0.0.3"
s.summary      = 'Integrate ProximateiOSSDK with your merchant or bank app (With Debug and live server enabling)'
...
# Or just: s.author    = "noorulain.ali"
# s.authors            = { "noorulain.ali" => "noorulain.ali@avanzasolutions.com" }
...
s.source_files  = "ProximateiOSSDK", "ProximateiOSSDK/ProximateiOSSDK/Classes/**/*.{swift,h,m}"
...
# s.resource  = "icon.png"
#   s.resources = "ProximateiOSSDK/ProximateiOSSDK/Assets/*.png"
s.resource_bundles = {
'ProximateiOSSDK' => ['ProximateiOSSDK/ProximateiOSSDK/Resources/*']
}
